"""SortSpotify: Command-line interface tools for managing and creating Spotify playlists"""
...
if __name__ == "__main__":
    print("""Welcome to SortSpotify: A command-line interface for managing and creating Spotify playlists.\nType HELP for list of available commands or EXIT to terminate.\n""")
    ...
    while True:
        ...
        try:
            ...
            print(exception)
    print("SortSpotify has terminated.")
